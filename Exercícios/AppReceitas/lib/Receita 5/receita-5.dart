...
// Exercício 1: As classes MyApp e DataTableWidget, são chamadas apenas uma vez, mas continuam sendo
// executadas pelo App. Como também a classe NewNavBar, mas funcionando de outra maneira, quando os
// bottomNavigationBar são tocados, a classe é chamda novamente, renderizando o botão.
...
class _NewNavBarState extends State<NewNavBar2> {
  _NewNavBarState();
